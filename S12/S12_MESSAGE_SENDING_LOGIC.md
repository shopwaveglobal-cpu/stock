...
### 위치
- 파일: `C:\Users\log\Desktop\Code\S12\Real_Time_Monitor.py`
...
send_realtime_alert(
    ...
    system_label=system_label,        # "S2" 또는 "S1"
...
- **위치**: `telegram_notifier.py` 253줄
- **기본값**: `system_label: str = "S2"`
...
슬랙 Block Kit API를 사용하여 구조화된 메시지 전송
...
**결과:**
- 텔레그램: ✅ [S2] 1차 매수 체결! 메시지 전송 (모든 수신자)
- 슬랙: ✅ [S2] 1차 매수 체결! Block Kit 메시지 전송
