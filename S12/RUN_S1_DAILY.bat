...
chcp 65001 > nul
REM ========================================
REM S1 Trading System - Daily Run (20:15)
REM ========================================
...
REM ===== Step 2: S1 Trading Signal Generation =====
echo [2/2] S1 Trading Signal Generation...
echo ========================================
echo [2/2] S1 Trading Signal Generation... >> "%LOG_FILE%"

python Trading_Signal_System.py --appkey IweTdkYa8JWDUOa8NohVSVeOiJ1THDGd_2x050A8XcU --secret eazu-jPNJpAsIVkaUTh3_88gUvXrCMJCwGF2AYRtBJs --alert-threshold 10.0 --signal output/trading_signals_s1.xlsx >> "%LOG_FILE%" 2>&1
