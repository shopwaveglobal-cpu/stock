...
TELEGRAM_CHAT_ID_ME=your_chat_id_here
TELEGRAM_CHAT_ID_YOONJOO=your_chat_id_here
TELEGRAM_CHAT_ID_MINJEONG=your_chat_id_here
TELEGRAM_CHAT_ID_JUMEONI=your_chat_id_here
```
